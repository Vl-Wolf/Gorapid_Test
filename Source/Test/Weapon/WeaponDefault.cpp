...
#include "Test/Character/Test_InventoryComponent.h"
...
bool AWeaponDefault::CheckCanWeaponReload()
{
	...
	if (GetOwner())
	{
		UTest_InventoryComponent* MyInventory = Cast<UTest_InventoryComponent>(GetOwner()->GetComponentByClass(UTest_InventoryComponent::StaticClass()));
		if (MyInventory)
		{
