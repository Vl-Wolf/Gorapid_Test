...
void ATTCharacter::CharacterDead()
{
	...
	if (HasAuthority())
	{
		...
		GetWorldTimerManager().SetTimer(TimerHandle_RagdollTimer, this, &ATTCharacter::EnableRagdoll,
...
void ATTCharacter::EnableRagdoll()
{
	if (GetMesh())
	{
...
void ATTCharacter::TrySwitchWeapon(int32 ToIndex)
{
...
void ATTCharacter::SetActorRotationByYaw(float Yaw)
{
...
void ATTCharacter::SetMovementState(EMovementState NewState)
{
	MovementState = NewState;
	CharacterUpdate();
}

void ATTCharacter::PlayAnim(UAnimMontage* Anim)
{
